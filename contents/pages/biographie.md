...
J'ai donc toujours oscillé entre vie rurale et plaisir de cotôyer les rues de Douai.

J'ai grandi dans une famille nombreuse de 6 frères et soeurs avec d'importants écarts d'âge dûs aux remariages de mes parents. J'ai donc eu très tôt le sens du partage et des responsabilités.
...
Avec plusieurs amis nous vons créé un cercle de programmeurs/euses nommé ["ChtiJS"](https://chtijs.francejs.org/) qui nous a permis de mettre en avant une technologie aujourd'hui largement utilisée dans le milieu du web. Peu de temps après, nous fîmes, en national, la même démarche avec [FranceJS](http://francejs.org/).
...
C'est [ce parcours](https://www.linkedin.com/in/nfroidure/), un peu particulier, mais courronné de petites victoires qui aujourd'hui me permet de travailler à 80% et de consacrer du temps à oeuvrer au changement de notre société.
...
Paradoxalement, j'ai fait trois enfants. J'ai toujours voulu avoir des enfants aussi loin que je me souvienne d'avoir pensé à cette éventualité. Cette volonté n'a jamais faiblie.

C'est une lueur d'espoir, une conviction que notre société peut se transformer, que de l'Humanité, peut surgir aussi le meilleur. Mais ce meilleur, il va falloir aller le chercher, en être acteur. D'où mon engagement politique qui a comencé par une "simple" adhésion à EÉLV.
...
Les revendications des gillets jaunes ont agit comme un électrochoc. Le malaise dont elles et ils ont pu témoigner et dont j'ai, un temps, partagé les causes et la violence repressive sans aucune tentative de dialogue m'ont littéralement révulsé.
...
Ce parcours non-linéaire m'a, en effet, permis de développer une conscience forte de chaque strate de la société, une conscience qui fait défaut chez la plupart des personnalités poliques. Loin des filières d'excellence, j'ai néanmoins, de façon autodidacte, pu développer suffisamment de compétences pour envisager sérieusement mon entrée dans la sphère politique.
